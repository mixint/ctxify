/**
@ctxify/ctxify/node_modules/bin/render
require('bin/render')
**/
...
async function renderAnyElement(globject){
	// if(globject instanceof Promise){
	// 	globject = await globject
	// }
